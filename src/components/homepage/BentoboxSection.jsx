                ...
                <div className="flex justify-center">
                    <div className="flex flex-row  h-[600px]  w-[75%]">
                        <div className="w-[45%]  flex justify-center">
                            <Link to='/viewrecipe/687fddda78a7a28547f32365' className="w-[485px] h-[100%] bg-alabaster rounded-[35px] hover:brightness-90">
                                <div className="h-[80%] ">
                            ...
                            <div className="w-[96%] h-full ">
                                <div className="w-full h-2/4 flex flex-row">
                                    <div className="w-2/4 h-full flex justify-center items-center  ">
                                        <Link to='/viewrecipe/687fddda78a7a28547f323f5' className="w-[90%] h-[98%] bg-alabaster rounded-[35px] hover:brightness-90">
                                    ...
                                    <div className="w-2/4 h-full flex justify-center items-center  ">
                                        <Link to='/viewrecipe/687fddd878a7a28547f321ad' className="w-[90%] h-[98%] bg-alabaster rounded-[35px] hover:brightness-90">
                                            <img className="h-[70%] w-full rounded-t-[35px] object-cover" src="https://img.hellofresh.com/c_fit,f_auto,fl_lossy,h_1100,q_auto,w_2600/hellofresh_s3/image/sun-dried-tomato-risotto-6b0bfeb8.jpg" alt="" />
                                            <div className="flex justify-center">
                                                <div className="text-2xl  font-font3 font-bold w-[95%] text-matterhorn pt-1.5">Sun-Dried Tomato Risotto</div>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
                                <div className=" h-2/4 flex justify-center items-end">
                                    <Link to='/viewrecipe/687fddd978a7a28547f32320' className=" w-[95%] h-[90%] rounded-[35px] bg-alabaster flex flex-row hover:brightness-90">
